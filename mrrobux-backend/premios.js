...
let DATA_FILE = process.env.PREMIOS_DATA_FILE ||
  path.join(__dirname, 'data', 'premios.json');
...
function ensureDataDir() {
  ...
  } catch (e) { /* si no se puede, saveDb lo reporta */ }
}
 ...
 * @param {string} [opts.dataFile]
 *        Dónde guardar los datos de premios. Por defecto data/premios.json.
 */
